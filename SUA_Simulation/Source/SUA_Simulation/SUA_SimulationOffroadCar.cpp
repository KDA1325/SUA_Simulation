...
#include "SUA_SimulationOffroadCar.h"
#include "SUA_SimulationOffroadWheelFront.h"
#include "SUA_SimulationOffroadWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"
#include "GameFramework/SpringArmComponent.h"

ASUA_SimulationOffroadCar::ASUA_SimulationOffroadCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = USUA_SimulationOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = USUA_SimulationOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = USUA_SimulationOffroadWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = USUA_SimulationOffroadWheelRear::StaticClass();
