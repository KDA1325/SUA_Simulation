...
#include "SUA_SimulationSportsCar.h"
#include "SUA_SimulationSportsWheelFront.h"
#include "SUA_SimulationSportsWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"

ASUA_SimulationSportsCar::ASUA_SimulationSportsCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = USUA_SimulationSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = USUA_SimulationSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = USUA_SimulationSportsWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = USUA_SimulationSportsWheelRear::StaticClass();
